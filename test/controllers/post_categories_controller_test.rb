...
class PostCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_category" do
    assert_difference('PostCategory.count') do
      post post_categories_url, params: { post_category: { name: @post_category.name, slug: @post_category.slug } }
    end
  ...
  test "should update post_category" do
    patch post_category_url(@post_category), params: { post_category: { name: @post_category.name, slug: @post_category.slug } }
