class EditorialServicesController < ApplicationController
    ...
    def manuscript_editing
      ...
      @page_description = "Manuscript editing for serious writer. Discover how our combined developmental editing and line editing will give you the feedback and help you need to lift your book to a publishable standard."
      @keyword = "manuscript"  
      @testimonial_count = Testimonial.all.count
    end
    ...
    def novel_editing
      ...
      @page_description = "Looking for a novel editor? Novel editing for serious writer. Discover how our novel editing will give you the feedback and help you need to lift your book to a publishable standard."
      @keyword = "novel"
      @testimonial_count = Testimonial.all.count
    end
